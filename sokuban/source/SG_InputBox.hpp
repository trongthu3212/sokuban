...
#define CLASSNAME					"SG_Inputbox"
#define PUSH_BUTTON					"Button"
#define FONT_NAME					_T("Times")
#define TEXTEDIT_CLASS				"edit"
...
public:
	static LPSTR GetString(LPCTSTR szCaption, LPCTSTR szPrompt, LPCTSTR szDefaultText);
